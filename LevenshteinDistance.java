/** Class that implements a method to compare strings based on the
    Levenshtein Distance
*/
public class LevenshteinDistance implements StringComparator{

  /** Compute the edit distance (Levenshtein Distance) between strings x
  ...
  Uses dynamic programming to solve this task as per the algorithm at
  https://en.wikipedia.org/wiki/Levenshtein_distance#Iterative_with_full_matrix.
  Possible to optimize the performance of this using the two-row
  approach or a global matrix though both would introduce complications.
  */
